...
| Collation compare | `Intl.Collator.prototype.compare` | `collator/collator.go`, pointer-shared immutable state plus per-call pooled backend, `Compare` | `collator/collator_test.go` copy/concurrency witnesses, `collator/search_sensitivity_test.go` |
