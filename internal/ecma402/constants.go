...
// simpleUnits is the de-namespaced form of SanctionedUnits, used by
// IsSanctionedSimpleUnitIdentifier. Computed once at package init.
var simpleUnits = func() []string {
