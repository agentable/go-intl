...
func LoadAll(ctx context.Context, root string, versions Versions, localeAllowlist []string) (*Source, error) {
	...
	return &Source{Root: resolved, Versions: versions, Available: available, LikelySubtags: likely, Numbers: numbers, Currencies: currencies, CurrencyFractions: fractions, Collations: collations, LanguageMatching: matching, Regions: regions, Dates: dates, Preference: preference, Metazones: metazones, Units: units}, nil
}
