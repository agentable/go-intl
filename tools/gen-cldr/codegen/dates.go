...
func renderDates(dates extract.Dates, table *StringTable) ([]byte, error) {
	...
	b.WriteString("var datesByLocale = map[Locale]map[string]calendarData{\n")
	...
	b.WriteString("}\n\n")
	b.WriteString("var dayPeriodRules = ")
...
func GregorianFor(loc Locale) Gregorian {
	data := datesByLocale[loc]["gregorian"]
...
func renderPreference(data extract.PreferenceData, table *StringTable) ([]byte, error) {
	...
	b.WriteString("var hourCyclePreference = map[string][]string{\n")
	...
	b.WriteString("}\n\n")
	b.WriteString("var weekPreferenceByRegion = map[string]weekPreference{\n")
	...
	b.WriteString("}\n\n")
	b.WriteString("var calendarPreference = map[string][]string{\n")
