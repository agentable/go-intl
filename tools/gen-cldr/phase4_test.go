...
func TestRunGeneratesNumbersAndCurrencies(t *testing.T) {
	...
	if !containsAll(string(numbers), "type NumberSymbols", "func (l Locale) NumberSymbols", "func (l Locale) CurrencyPattern") {
...
func writePhase4CLDRFixture(t *testing.T, root string) {
	t.Helper()
