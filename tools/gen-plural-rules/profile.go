...
// LocaleProfile mirrors tools/gen-cldr/profile.go. PluralRules uses the shared
// CLDR-backed locale profile so generated plural support follows the data set.
